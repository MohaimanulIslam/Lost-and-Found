package com.example.lostandfoundpro.ui.barishal;
...
public class Barishal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v =  inflater.inflate(R.layout.fragment_barishal, container, false);
...
//        recyclerView.setAdapter(adapter);
        ...
        if (firebaseAuth.getCurrentUser() != null){
            ...
            query = firebaseFirestore.collection("PostDetails").orderBy("Time",Query.Direction.DESCENDING).whereEqualTo("LocationValue","Barisal");
