package com.example.lostandfoundpro.ui.khulna;
...
public class Khulna extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root =  inflater.inflate(R.layout.fragment_khulna, container, false);
...
//        recyclerView.setAdapter(adapter);
        ...
        if (firebaseAuth.getCurrentUser() != null){
            ...
            query = firebaseFirestore.collection("PostDetails").orderBy("Time",Query.Direction.DESCENDING).whereEqualTo("LocationValue","Khulna");
