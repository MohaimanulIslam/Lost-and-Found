package com.example.lostandfoundpro.ui.chittagong;
...
public class Chittagong extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_chittagong, container, false);
...
//        recyclerView.setAdapter(adapter);
        ...
        if (firebaseAuth.getCurrentUser() != null){
            ...
            query = firebaseFirestore.collection("PostDetails").orderBy("Time",Query.Direction.DESCENDING).whereEqualTo("LocationValue","Chittagong");
