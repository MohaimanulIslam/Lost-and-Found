package com.example.lostandfoundpro.ui.sylhet;
...
public class Sylhet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_sylhet, container, false);
...
//        recyclerView.setAdapter(adapter);
        ...
        if (firebaseAuth.getCurrentUser() != null){
            ...
            query = firebaseFirestore.collection("PostDetails").orderBy("Time",Query.Direction.DESCENDING).whereEqualTo("LocationValue","Sylhet");
