package com.example.lostandfoundpro.ui.Mymenshing;
...
public class Mymenshing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root =  inflater.inflate(R.layout.fragment_mymenshing, container, false);
...
//        recyclerView.setAdapter(adapter);
        ...
        if (firebaseAuth.getCurrentUser() != null){
            ...
            query = firebaseFirestore.collection("PostDetails").orderBy("Time",Query.Direction.DESCENDING).whereEqualTo("LocationValue","Mymensingh");
